    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
              content: Text(
                  'Échec de la génération de la nouvelle politique ACL : $e',
                  style:
  ...
  Future<void> _shareAclFile() async {
    try {
      ...
      await Share.shareXFiles([XFile(file.path)],
          text: 'Voici votre nouvelle politique ACL Headscale.');
    } catch (e) {
