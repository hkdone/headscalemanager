              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildInfoCard(context, children: [
                    ...
                    const SizedBox(height: 8),
                    _buildBodyText(context, 'There are two main methods:'),
                    const SizedBox(height: 8),
                    _buildBodyText(context,
...
routes:
   enabled: true''',
                  ...
                  _buildInfoCard(context, children: [
                    ...
                    const SizedBox(height: 8),
                    _buildBodyText(
                        context, '**Basic Principle: Strict User Isolation**',
                        isBold: true),
                    const SizedBox(height: 4),
                    _buildBodyText(
                      context,
                    ...
                    const SizedBox(height: 8),
                    _buildBodyText(context, '**Features:**', isBold: true),
                    const SizedBox(height: 4),
                    _buildBodyText(
                      context,
                    ...
                    const SizedBox(height: 8),
                    _buildBodyText(context, '**Main Features:**', isBold: true),
                    const SizedBox(height: 4),
                    _buildBodyText(
                      context,
                  ...
                  _buildInfoCard(context, children: [
                    ...
                    const SizedBox(height: 16),
                    _buildBodyText(
                        context, 'B. Specific Permissions (ACL Exceptions)',
                        isBold: true),
                    const SizedBox(height: 8),
                    _buildBodyText(context,
                    ...
                    const SizedBox(height: 8),
                    _buildBodyText(
                        context, '**Specific Case: Access to Shared Subnets**',
                        isBold: true),
                    _buildBodyText(
                      context,
                    ...
                    const SizedBox(height: 16),
                    _buildSubTitle(
                        context, '4.2. Notifications and Monitoring'),
                    const SizedBox(height: 8),
      ...
      onMatch: (m) {
        spans.add(TextSpan(
          ...
          style: TextStyle(
            ...
            fontWeight: FontWeight.bold, // Always bold for what is matched
            height: 1.5,
          ),
        ));
        return '';
