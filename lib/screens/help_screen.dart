              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildSectionTitle(context,
                      'Tutoriel : Ajouter un appareil et le configurer'),
                  _buildInfoCard(context, children: [
                    _buildBodyText(context,
                    ...
                    const SizedBox(height: 16),
                    _buildSubTitle(
                        context, 'Étape 2 : Enregistrer l\'appareil'),
                    const SizedBox(height: 8),
                    _buildBodyText(
...
routes:
   enabled: true''',
                  ...
                  const SizedBox(height: 24),
                  _buildSectionTitle(
                      context, '2. Configuration de l\'Application'),
                  _buildInfoCard(context, children: [
                    _buildBodyText(
                  ...
                  _buildSectionTitle(
                      context, '3. Utilisation de l\'Application'),
                  _buildInfoCard(context, children: [
                    _buildBodyText(context,
                  ...
                  _buildInfoCard(context, children: [
                    ...
                    const SizedBox(height: 16),
                    _buildBodyText(
                        context, 'A. Automatisation depuis le Tableau de Bord',
                        isBold: true),
                    const SizedBox(height: 8),
                    _buildBodyText(context,
                    ...
                    const SizedBox(height: 8),
                    _buildBodyText(context, '**Nettoyage intelligent :**',
                        isBold: true),
                    _buildBodyText(
                      context,
                    ...
                    const SizedBox(height: 16),
                    _buildSubTitle(
                        context, '4.2. Notifications et Surveillance'),
                    const SizedBox(height: 8),
                    ...
                    const SizedBox(height: 8),
                    _buildBodyText(
                        context, 'B. Surveillance du Statut par Nœud',
                        isBold: true),
                    _buildBodyText(
                      context,
